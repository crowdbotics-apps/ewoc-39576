"""
Django settings for ewoc_39576 project.
...
WSGI_APPLICATION = 'ewoc_39576.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ewoc_39576 API",
    "DESCRIPTION": "API documentation for ewoc_39576 App",
    "VERSION": "v1",
}
